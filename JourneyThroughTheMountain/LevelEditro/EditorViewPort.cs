...
{
    public class EditorViewPort : MonoGameControl
    {
       
       public System.Windows.Forms.Form Appform;
        ...
        public void Initialize(System.Windows.Forms.Form MainForm)
        {
            Appform.SizeChanged += MainForm_SizeChanged;
            vScroll = (System.Windows.Forms.VScrollBar)MainForm.Controls["vScrollBar1"];
            hScroll = (System.Windows.Forms.HScrollBar)MainForm.Controls["hScrollBar1"];
            DebugBox = (System.Windows.Forms.ListBox)MainForm.Controls["LstDebugBox"];
            //Mouse.WindowHandle = MainForm.Handle;
            base.Initialize();
        ...
        public void LoadProject()
        {
            ...
            TileMap.Initialize(Editor.Content.Load<Texture2D>(@"CastleTilemap"));
